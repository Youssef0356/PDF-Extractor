...
FIELD_DESCRIPTIONS: dict[str, dict] = {
    ...
    "categorie": {
        ...
        "search_queries": [
            "sensor transmitter category type instrument",
            "temperature sensor pressure transmitter flowmeter",
            "capteur transmetteur catégorie type",
    ...
    "alimentation": {
        ...
        "allowed_values": None,
        "search_queries": [
            "power supply voltage VDC VAC",
            "supply voltage 24V 12V 220V",
    ...
    "reperage": {
        ...
        "allowed_values": None,
        "search_queries": [
            "tag number instrument tag repère",
            "P&ID tag identification",
            "FT PT LT TT tag numéro",
            "instrument identification plaque signalétique",
            "repérage identification appareil",
        ],
    },
